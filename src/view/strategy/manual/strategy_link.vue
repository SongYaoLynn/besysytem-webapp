...
// test data
// import { productionLinkTest } from '@/api/testData'
  ...
  methods: {
    ...
    test() {
      getManualLinkDetailData({
        startTime: this.timeStartTemp,
        endTime: this.timeEndTemp,
        flat: this.findDepartment("陆侧邮件作业区", "flat", "综合"),
        air: this.findDepartment("陆侧邮件作业区", "air", "综合"),
        ground: this.findDepartment("陆侧邮件作业区", "ground", "综合")
      })
        .then(res => {
          // this.baseData = res.data
          // 错误判断

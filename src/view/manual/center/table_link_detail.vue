<template>
  <div>
    <Card >
      ...
      <i-table :columns="linkDetailHeader" :data="linkDetailContent" size="small" ref="table"></i-table>
      <br>
...
export default {
    ...
    return {
      ...
      linkDetailHeaderTemp: [
        ...
        },
        {
          ...
          key: "本环节分摊成本"
          // render: (h, params) => {
          //   return h('div', params.row['本环节分摊成本'].toFixed(2))
          // }
        },
        {
          title: "总成本",
  ...
  methods: {
    ...
    updateData() {
      console.log("this.dataList[this.$route.params.id]");
      console.log(this.dataList[this.$route.params.id]);
      this.linkDetailData = {};
